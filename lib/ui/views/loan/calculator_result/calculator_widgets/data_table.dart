         ...
         dataRowMaxHeight: 3,
            columns: [
              ...
              DataColumn(label: SizedBox(
                width: 40,
                child: CustomText(text:'Period',textAlign: TextAlign.end,color: darkGreenHeigh,fontSize: 10,)),),
              DataColumn(label: SizedBox(
                width: 60,
                // height: 200,
            ...
            rows:[
              ...
              DataRow(cells: [
                DataCell(SizedBox( width: 30,child: CustomText(text:'1',textAlign: TextAlign.center,fontSize: 10,))),
              ...
              DataRow(cells: [
                DataCell(SizedBox( width: 30,child: CustomText(text:'2',textAlign: TextAlign.center,fontSize: 10,))),
                DataCell(SizedBox(width: 60,child: Center(child:CustomText(text:"\$6.36.777",textAlign: TextAlign.center,fontSize: 8)))),
                DataCell(SizedBox(width: 60,child: Center(child:CustomText(text:"\$65.36.777",textAlign: TextAlign.center,fontSize: 8,)))),
                DataCell(SizedBox(width: 60,child: Center(child:CustomText(text:"\$65.36.777",textAlign: TextAlign.center,fontSize: 8,)))),
                 DataCell(SizedBox(width: 60,child: Center(child:CustomText(text:"\$654.36.777",textAlign: TextAlign.center,fontSize: 8,)))),
