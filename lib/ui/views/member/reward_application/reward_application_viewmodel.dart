...
class RewardApplicationViewModel extends BaseViewModel {
  ...
  final typeOfProductList = ["Loan", "Mortgage", "Card","Account","Imsurance"];
  setTypeOfProduct(value) {
    typeOfProduct = value;
    notifyListeners();
  }

final institutionList = ["DBS BAnk(Hong Kong)", "PrimeCredit", "China Citic Bank International"];
  setInstitution(value) {
    institution = value;
    notifyListeners();
  }

  final rewardDetailsList = ["MONEY PLAZA Reward Rebate Up to 1% Cash Rebate",
